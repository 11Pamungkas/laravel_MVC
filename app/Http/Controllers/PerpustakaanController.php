...
class PerpustakaanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'perpustakaan.index',
            compact('nama_sistem', 'versi', 'total_buku', 'buku_list')
        );
    }
    ...
    public function show($id)
    {
        $buku_list = [
            1 => [
                ...
                'harga' => 75000,
                'stok' => 10,
                'deskripsi' => 'Buku panduan lengkap pemrograman PHP'
            ],
            ...
            2 => [
                ...
                'harga' => 125000,
                'stok' => 5,
                'deskripsi' => 'Membangun aplikasi dengan Laravel'
            ]
        ];
